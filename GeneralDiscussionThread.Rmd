...
Chien: Cleaned stuff
-----
Jason: 11/27 - Continued exploration with little significance. Code updated with some mundane plotting, running linear model, and regsets to determine variable importance and best number. Cleaned up dataset due to a few errors in the past few days. 
